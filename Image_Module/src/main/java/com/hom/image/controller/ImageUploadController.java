package com.hom.image.controller;
...
import com.hom.image.service.ImageUplodeService;
...
public class ImageUploadController {
	 ...
	 System.out.println("Mostafa");
		 ...
		 * 
		 * ImageModelEntity img = new ImageModelEntity(file.getOriginalFilename(),
		 * file.getContentType(),
		 * 
		 ...
		 */
	    	 imageUplodeService.upLodeImage(file);
		...
		/*
		 * final Optional<ImageModelEntity> retrievedImage =
		 * imageRepository.findByName(imageName);
		 * 
		 * ImageModelEntity img = new ImageModelEntity(retrievedImage.get().getName(),
